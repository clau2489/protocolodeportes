...
<head>
  ...
  <link href="../assets/img/icono.png" sizes="32x32" rel="icon" type="image/png"  />
    ...
    <div class="container">
      <div class="row"> 
        <div class="offset-md-3 col-md-6 p2 text-center">
          <img src="../assets/img/cuidarte.jpg" width="200px;">
          <br>
          <br>
          <div class="alert alert-danger" role="alert">
            <h4 class="alert-heading">No se encontraron datos</h4>
            <p>No se han encontrado registros con su número de documento o no se han encontrado datos de la actualización de su estado de salud. <br>Recuerde que debe realizar el autodiagnóstico cada 48hs. </p>
          </div>
          <br>
          <a class="btn btn-block btn-primary" href="../index.php">Realizar autodiagnóstico</a>          
        </div>
      </div>
    </div>
  </section> 
